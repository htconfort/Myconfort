...
const articles = [
  ...
  {
    title: "Art. 8 - Tailles des Matelas",
    content:
  ...
  {
    title: "Art. 9 - Odeur des Matériaux",
    content:
  ...
  {
    title: "Art. 10 - Règlements et Remises",
    content:
  ...
  {
    title: "Art. 15 - Garanties Légales",
    content:
  ...
  {
    title: "Art. 17 - Horaires de Livraison",
    content:
...
export const TermsAndConditions = () => (
  <div style={{ fontFamily: 'Times New Roman, serif', fontSize: 11, color: '#333', padding: 32, background: '#fff', maxWidth: 800, margin: '0 auto' }}>
    <div style={{ textAlign: 'center', marginBottom: 30, borderBottom: '2px solid #333', paddingBottom: 15 }}>
      <h1 style={{ fontSize: 22, fontWeight: 'bold', margin: 0, textTransform: 'uppercase', letterSpacing: 1 }}>
        Conditions Générales de Vente
      </h1>
      <div style={{ marginTop: 15, fontSize: 16, fontWeight: 'bold', color: '#d32f2f', textTransform: 'uppercase', letterSpacing: 0.5 }}>
    ...
    {articles.map((art, i) => (
      <div key={i} style={{ marginBottom: 20 }}>
        <div style={articleTitleStyle}>{art.title}</div>
        <div style={articleContentStyle}>{art.content}</div>
      </div>
    ))}

    <div style={{ marginTop: 24, textAlign: 'center', fontSize: 12, background: '#f5f5f5', padding: 10, borderRadius: 5 }}>
      <strong>Contact :</strong> myconfort66@gmail.com
    </div>

    <div style={{ marginTop: 30, textAlign: 'center', fontStyle: 'italic', fontSize: 11, borderTop: '1px solid #666', paddingTop: 15 }}>
